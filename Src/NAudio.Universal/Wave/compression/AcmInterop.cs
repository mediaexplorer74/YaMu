...
namespace NAudio.Wave.Compression
{
    ...
    class AcmInterop
    {
        ...
        public static extern MmResult acmFormatSuggest(
            IntPtr hAcmDriver,
            [In, MarshalAs(UnmanagedType.Interface/*.CustomMarshaler*/, MarshalType = "NAudio.Wave.WaveFormatCustomMarshaler")] 
            WaveFormat sourceFormat,
            [In, Out, MarshalAs(UnmanagedType.Interface/*.CustomMarshaler*/, MarshalType = "NAudio.Wave.WaveFormatCustomMarshaler")] 
